...
from Exception.exception import CustomerNotFoundException,ProductNotFoundException
            ...
            if s.customer_exists(name,password) > 0:
               ...
               if products_in_cart:
                  ...
                  for product in products_in_cart:
                     print(f"Product id: {product[0]} , Product Name: {product[1]}, price: ${product[2]}, description:{product[3]}, quantity: {product[4]}") 
